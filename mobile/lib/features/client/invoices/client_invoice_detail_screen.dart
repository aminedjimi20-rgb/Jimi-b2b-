...
final _clientInvoiceProvider = FutureProvider.autoDispose.family<InvoiceView, String>((ref, id) {
  return ref.watch(invoicesApiProvider).getForClient(id);
});

class ClientInvoiceDetailScreen extends ConsumerStatefulWidget {
  const ClientInvoiceDetailScreen({super.key, required this.invoiceId});
  final String invoiceId;

  @override
  ConsumerState<ClientInvoiceDetailScreen> createState() => _ClientInvoiceDetailScreenState();
}

class _ClientInvoiceDetailScreenState extends ConsumerState<ClientInvoiceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final invoice = ref.watch(_clientInvoiceProvider(widget.invoiceId));
    ...
    return Scaffold(
      ...
      body: AsyncValueWidget<InvoiceView>(
        value: invoice,
        onRetry: () => ref.invalidate(_clientInvoiceProvider(widget.invoiceId)),
        data: (inv) {
          final o = inv.order;
          return ListView(
